...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            dragDropStr: "<div class='drag-tip'>或者将文件拖到此处</div>",
            uploadStr:"Upload",
            abortStr: "Abort",
            cancelStr: "Cancel",
            deleteStr: "Delete",
	...
	this.enqueueFile = function(file){
		...
		function defaultProgressBar(obj,s)
		{
            ...
            this.filename = $("<div class='ajax-file-upload-filename' style='display:none;'></div>").appendTo(this.statusbar);
            this.imginfo = $("<div class='ajax-file-upload-tip'><div><input type='text' class='input-img-title' placeholder='请输入图片标题'><input type='radio' name='select-first-img' /></div><textarea placeholder='请输入图片描述'></textarea></div>").appendTo(this.statusbar);
            this.progressDiv = $("<div class='ajax-file-upload-progress'>").appendTo(this.statusbar).hide();
            this.progressbar = $("<div class='ajax-file-upload-bar'></div>").appendTo(this.progressDiv);
            this.progressbarBtn = $("<div class='ajax-file-upload-bar-btn'></div>").appendTo(this.progressDiv);
            this.abort = $("<div>" + s.abortStr + "</div>").appendTo(this.progressbarBtn).hide();
            this.cancel = $("<div>" + s.cancelStr + "</div>").appendTo(this.progressbarBtn).hide();
            this.done = $("<div>" + s.doneStr + "</div>").appendTo(this.progressbarBtn).hide();
            this.download = $("<div>" + s.downloadStr + "</div>").appendTo(this.progressbarBtn).hide();
            this.del = $("<div>" + s.deleteStr + "</div>").appendTo(this.progressbarBtn).hide();
        ...
        function ajaxFormSubmit(form, s, pd, fileArray, obj, file) {
            ...
            var options = {
                ...
                uploadProgress: function (event, position, total, percentComplete) {
                    ...
                    if(s.showProgress) {
                        pd.progressbar.html('<span>' + percentVal + '</span>');
                ...
                success: function (data, message, xhr) {
                    ...
                    pd.progressbar.width('100%');
                    if(s.showProgress) {
                        pd.progressbar.html('<span>100%</span>');
                        pd.progressbar.css('text-align', 'center');
                    }
